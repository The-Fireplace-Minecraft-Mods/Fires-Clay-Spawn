...
public class VersionChecker {
	private static final String HostMODID=ClaySpawn.MODID;
	private static final String HostMODNAME=ClaySpawn.MODNAME;
	private static final String HostVERSION=ClaySpawn.VERSION;
	...
	public VersionChecker(){
		latest = stringAt(ClaySpawn.LATEST);
		downloadURL = ClaySpawn.downloadURL;
	}
