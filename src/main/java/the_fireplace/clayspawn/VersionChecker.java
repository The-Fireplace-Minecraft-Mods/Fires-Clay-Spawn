...
public class VersionChecker {
	static final String HostMODID=ClaySpawn.MODID;
	private static final String HostMODNAME=ClaySpawn.MODNAME;
	...
	private String getVersionFromJson(){
		try{
			...
			if(file.exists()) {
				...
				String tempMODNAME = HostMODNAME.replace(" ", "").replace("\'", "");
				int jarindex = contents.indexOf(tempMODNAME+"-");
				int versionindex = jarindex + tempMODNAME.length()+1;
